...
public class ApiExcepetionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        ProblemaType problemType = ProblemaType.MENSAGEM_INCOMPRIENCIVEL;
    ...
    public ResponseEntity<?> handleEntidadeNaoEncontrada(EntidadeNaoEncotrada ex,
                                                         WebRequest request) {
    ...
    public ResponseEntity<?> handleNegocio(NegocioExcepetion ex, WebRequest request) {
